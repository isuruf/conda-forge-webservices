...
def update(repo_name, pkgs):
    ...
    if repo_name == "conda-forge-webservices":
        ...
        # We don't have a way to know which versions were actually built into the docker image.
        # Assume that the latest ones were installed.
        url = f"https://raw.githubusercontent.com/conda-forge/{repo_name}/main/pkg_versions.json"
